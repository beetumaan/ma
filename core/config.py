# Stock universe and chart timeframe configuration.
# NSE_SYMBOLS is the Nifty 500 universe, last synced May 2026.
# To refresh bi-monthly, run: python3 scripts/refresh_nifty500.py

# ── PSU symbols (used by scanner to tag isPSU) ───────────────────────
PSU_SYMBOLS = {
    'BEL', 'SBIN', 'ONGC', 'COALINDIA', 'IOC', 'BHEL', 'NTPC', 'POWERGRID',
    'GAIL', 'HAL', 'BPCL', 'HPCL', 'OIL', 'NHPC', 'SAIL', 'RECLTD', 'PFC',
    'IRFC', 'CONCOR', 'NMDC', 'SJVN', 'CANBK', 'PNB', 'BANKBARODA',
    'UNIONBANK', 'LICI', 'IRCTC', 'BDL', 'HUDCO', 'RVNL', 'RAILTEL',
    'IREDA', 'IRCON', 'NBCC', 'NCC', 'NLCINDIA', 'IOB', 'BANKINDIA',
    'CENTRALBK', 'UCOBANK', 'MAHABANK', 'INDIANB', 'MMTC', 'MRPL',
    'ENGINERSIN', 'GRSE', 'MAZAGON', 'COCHINSHIP', 'MIDHANI', 'BEML',
    'GICRE', 'NIACL', 'SCI', 'RITES', 'NTPCGREEN', 'SJVN',
}

# ── Nifty 500 universe (last synced May 2026) ────────────────────────
NSE_SYMBOLS = [
...
# ── Chart timeframe map ──────────────────────────────────────────────
# Maps UI timeframe key → (yfinance period, interval)
